...
module.exports = (app) => {
    app.post('/api/user/register', Usercontroller.registerUser),
        ...
        app.put('/api/user/update_password', [jwt_helper.verifyAccessToken, passport.authenticate('jwt', { session: false })], Usercontroller.changePassword),
        app.post('/api/user/restore_password', Usercontroller.changeByEmail)
